...
namespace BananaWatch.Pages
{
    ...
    {
        public override string Title => "<color=#ffff00>Platform Monke V2</color>";
        ...
        public string SelectionArrow(int index, string text)
        {
            ...
            {
                // Use " >" for the first option (Enabled), and "<>" for others
